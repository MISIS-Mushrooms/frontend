Это фронтенд к нашему решению 19-й задачи ЛЦТ 2023. Основные элементы стека: TypeScript, React, Next.js, MUI. Иллюстрации к занятиям сгенерированы с помощью Stable Diffusion.
